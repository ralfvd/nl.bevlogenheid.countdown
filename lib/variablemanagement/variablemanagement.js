        ...
        //create tokens
                ...
                function (action) {
                  ...
                  if (action == 'changedvariables') {
                    console.log('set variable management')
...
function updatevariable(name, value, type, remove = false) {
        ...
        const oldvariable = findvariable(variables, variable);
	      if (setdate == '') {
...
function processValueChanged(variables, oldVariable, newVariable) {
    ...
    if (newVariable) {
      console.log("nieuwe variable")
      getTrigger('if_variable_set').trigger(null, { "variable": newVariable.name, "value": newVariable.value });
    }
